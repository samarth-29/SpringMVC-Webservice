...
public class AmazonSES {
	...
	final String FROM = "samarth_29@csu.fullerton.edu";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://localhost:8080/verification-service/email-verfication.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://localhost:8080/verification-service/email-verfication.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	public void verifyEmail(UserDto userDto) {
		...
		System.setProperty("aws.accessKeyId", "AKIA36CIMSOWQJW6LJOX"); 
		System.setProperty("aws.secretKey", "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"); 
